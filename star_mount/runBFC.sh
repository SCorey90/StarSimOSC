...
#root4star -l 'bfcRunner.C( '$2', "y2010 fzin TpcRS ITTF  McEvOut IdTruth McAna tpc_T globT db tpcDB VFMCE Idst event analysis EventQA EvOut StarMagField FieldOn IAna CMuDst vpdSim btofSim btofMixer btofMatch McAss", "'$1'" )'

 root4star -b -q -l '/users/PAS2524/corey90/star_mount/bfcRunner.C( '$2', "y2017 fzin TpcRS TpxClu TpcHitMover ITTF McEvOut IdTruth McAna tpc_T globT db tpcDB VFMCE Idst event analysis EventQA EvOut StarMagField FieldOn IAna CMuDst vpdSim btofSim btofMixer btofMatch McAss", "'$1'" )'
